...
namespace API.Migrations
{
    ...
    [Migration("20250521215542_AgregarTablaInventarioProgramado")]
    partial class AgregarTablaInventarioProgramado
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("tuco.Clases.Models.AlertasInventario", b =>
                {
                    ...
                    b.HasKey("AlertaId")
                        .HasName("PK__AlertasI__D9EF47E5A95249BE");
            ...
            modelBuilder.Entity("tuco.Clases.Models.DetalleInventario", b =>
                {
                    ...
                    b.Property<int?>("Diferencia")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("([CantidadContada]-[CantidadRegistrada])", false);
                    ...
                    b.HasKey("DetalleInventarioId")
                        .HasName("PK__DetalleI__C8A00126F5F24ACE");
            ...
            modelBuilder.Entity("tuco.Clases.Models.DetalleInventarioProgramado", b =>
                {
                    ...
                    b.ToTable("DetallesInventarioProgramado");
                });
