...
public class AuthController : ControllerBase
{
    ...
    public AuthController(IMemoryCache cache, TucoContext context, IConfiguration configuration, IHttpClientFactory httpClientFactory, EmailService emailService, ILogger<AuthController> logger)
    {
        _context = context;
