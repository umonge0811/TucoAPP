...
// ===== FUNCIÓN CENTRALIZADA PARA CONSTRUIR URLs DE IMÁGENES =====
function construirUrlImagen(producto) {
    console.log('🖼️ === INICIO construirUrlImagen ===');
    console.log('🖼️ Producto recibido:', producto.nombreProducto || producto.NombreProducto);
    ...
    try {
        ...
        if (imagenesArray.length > 0) {
            ...
            if (urlImagen && urlImagen.trim() !== '') {
                // Lógica robusta de construcción de URLs (EXACTA como verDetalleProducto)
    ...
    console.log('🖼️ === FIN construirUrlImagen - URL retornada:', imagenUrl, '===');
    return imagenUrl;
}
